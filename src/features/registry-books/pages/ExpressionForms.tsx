...
import { Bem } from "../../bem/types/Bem"
import CardBem from "../../bem/components/card-bem/CardBem"
import ModalBem from "../../bem/components/modal-bem/ModalBem"
import Filter from "../../../shared/components/ui/Filter"
import styles from './ExpressionForms.module.css';

export default function ExpressionForms() {
    ...
    if (loading) {
        return (
            <div id="book" className={styles.bookSection}>
